...
% JOSH: Modifed to work with CV-Class dataset
% This version is more general than v1 in this directory because v1 (script name FeatureBasedPanoramicImageStitchingExample.m)
% because v1 uses a hack of image-2, image-1, image-3 ordering.
% The problem with the hack is that it crops the left image.
% 
% This script modifies their example to work with image ordering:
...
% Load images - JOSH: Reduce dataset from 5 images down to three
% buildingDir = fullfile(toolboxdir('vision'), 'visiondata', 'building');
% buildingScene = imageDatastore(buildingDir);
% buildingScene = imageDatastore({'building1.jpg','building2.jpg','building3.jpg','building4.jpg','building5.jpg'});
% buildingScene = imageDatastore({'building1.jpg','building2.jpg','building3.jpg','building4.jpg'});
% buildingScene = imageDatastore({'building1.jpg','building2.jpg','building3.jpg'});
buildingScene = imageDatastore({'keble_a.jpg','keble_b.jpg','keble_c.jpg'});
